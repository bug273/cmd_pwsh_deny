...
New-ItemProperty -Path $registryPath -Name "DisablePowerShell" -Value 1 -PropertyType DWord -Force
...
# Establecer el valor para deshabilitar PowerShell
New-ItemProperty -Path $userRegistryPath -Name "DisablePowerShell" -Value 1 -PropertyType DWord -Force
